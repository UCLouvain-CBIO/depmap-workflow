...
days. As of the most current `20Q2` Depmap release, 1804 human cancer
...
`20Q2` release, tested 4,518 compounds against 578 cancer cell lines
...
Depmap data (starting from `19Q1` through `20Q2`) in the Cloud using
...
Shown below, datasets from the `20_Q2` release are downloaded in this way.
