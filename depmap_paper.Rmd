...
of interest from the `19_Q3` release are downloaded using the unique
`EH` numbers.
...
and may make an interesting candidate target. Figure \@ref(fig:histrpl14)
a plot of the `crispr` data is displayed as a histogram showing the
distribution of dependency scores for gene `RPL14`. The red dotted
